...
--
-- Hôte : localhost
-- Généré le : ven. 10 mars 2023 à 08:16
...
-- Procédures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `delete_praticien` (IN `id_praticien` INT)  BEGIN
   DELETE FROM praticien WHERE id = id_praticien;
END$$
...
(1, 2, '202109', 2, 4, NULL, '0.00'),
(2, 2, '202108', 2, 4, NULL, '0.00'),
(3, 2, '202105', 2, 2, NULL, '0.00'),
(4, 2, '202103', 2, 4, NULL, '85.00'),
(5, 2, '202210', 1, 5, NULL, '0.00'),
(6, 2, '202209', 1, 2, NULL, '0.00'),
(7, 1, '202102', 1, 2, '2021-02-04', '325.00');
...
(1, 4, '2021-04-12', '25.00', 'Bar à bière');
...
(0, 3, 2, 'Bertin', 'Evan', '1 avenue des champs elysée', '00000', 'Terre du milieu', '1789-07-14', 'ebert', 'secret', 'A'),
...
--
ALTER TABLE `frais`
  MODIFY `id_frais` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `fraishorsforfait`
  MODIFY `id_fraishorsforfait` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `visiteur`
  MODIFY `id_visiteur` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=104;
